...
public class InGameText extends Actor {
    ...
    public InGameText(GameStarter game, Font font, String[] keys, float x, float y, int[] indents, boolean is_key) {
    ...
    /** Recreates text redefining the h of the text. */
    public void setPlainText(GameStarter game, String key, boolean is_key) {
        if (text_type == TextType.PLAIN_TEXT) {
